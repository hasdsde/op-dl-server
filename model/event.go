...
type Event struct {
	...
	Primogems string         `gorm:"column:primogems;type:varchar(10);comment:原石数量" json:"primogems"`      // 原石数量
	Award     string         `gorm:"column:award;type:varchar(100);comment:其他奖励" json:"award"`             // 其他奖励
	PreTask   int64          `gorm:"column:pre_task;type:int(11);comment:前置任务，数字越大越长，0表示无" json:"preTask"` // 前置任务，数字越大越长，0表示无
	CoPlay    int64          `gorm:"column:co_play;type:int(11);comment:联机游戏 0为否" json:"coPlay"`           // 联机游戏 0为否
