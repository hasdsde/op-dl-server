...
func newUserEvent(db *gorm.DB, opts ...gen.DOOption) userEvent {
	...
	_userEvent.Todo = field.NewInt64(tableName, "todo")
	_userEvent.CreatedAt = field.NewTime(tableName, "created_at")
	_userEvent.UpdatedAt = field.NewTime(tableName, "updated_at")
	_userEvent.DeletedAt = field.NewField(tableName, "deleted_at")
...
type userEvent struct {
	...
	EventID   field.Int64 // 活动id
	Todo      field.Int64 // 已经完成数量
