...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.Primogems = field.NewString(tableName, "primogems")
	_event.Award = field.NewString(tableName, "award")
	_event.PreTask = field.NewInt64(tableName, "pre_task")
	_event.CoPlay = field.NewInt64(tableName, "co_play")
	_event.StartTime = field.NewTime(tableName, "start_time")
	_event.EndTime = field.NewTime(tableName, "end_time")
	...
	_event.TodoNum = field.NewInt64(tableName, "todo_num")
...
type event struct {
	...
	Primogems field.String // 原石数量
	Award     field.String // 其他奖励
	PreTask   field.Int64  // 前置任务，数字越大越长，0表示无
	CoPlay    field.Int64  // 联机游戏 0为否
...
func (e *event) updateTableName(table string) *event {
	...
	e.Primogems = field.NewString(table, "primogems")
	e.Award = field.NewString(table, "award")
	e.PreTask = field.NewInt64(table, "pre_task")
	e.CoPlay = field.NewInt64(table, "co_play")
	e.StartTime = field.NewTime(table, "start_time")
	e.EndTime = field.NewTime(table, "end_time")
	e.CreatedAt = field.NewTime(table, "created_at")
	e.DeletedAt = field.NewField(table, "deleted_at")
	e.UpdatedAt = field.NewTime(table, "updated_at")
	e.TodoNum = field.NewInt64(table, "todo_num")
...
func (e *event) fillFieldMap() {
	...
	e.fieldMap["primogems"] = e.Primogems
	e.fieldMap["award"] = e.Award
	e.fieldMap["pre_task"] = e.PreTask
	e.fieldMap["co_play"] = e.CoPlay
	e.fieldMap["start_time"] = e.StartTime
	e.fieldMap["end_time"] = e.EndTime
	e.fieldMap["created_at"] = e.CreatedAt
	e.fieldMap["deleted_at"] = e.DeletedAt
	e.fieldMap["updated_at"] = e.UpdatedAt
	e.fieldMap["todo_num"] = e.TodoNum
}
