...
func newVersion(db *gorm.DB, opts ...gen.DOOption) version {
	...
	_version.ID = field.NewInt64(tableName, "id")
	_version.Num = field.NewInt64(tableName, "num")
	_version.StartTime = field.NewTime(tableName, "start_time")
	_version.EndTime = field.NewTime(tableName, "end_time")
	_version.Title = field.NewString(tableName, "title")
	_version.Img = field.NewString(tableName, "img")
